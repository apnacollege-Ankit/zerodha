...
function Education() {
    ...
    <div className="container mt-5">
        <div className="row">
            ...
            <a href="" style={{textDecoration: "none"}}>Versity <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
            <p>
            <p className="mt-5">
            TradingQ&A, the most active trading and investment community in India for all your market related queries.</p>
            <a href="" style={{textDecoration: "none"}}>TradingQ&A  <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a></p>
        </div>
        </div>
    </div>
    );
